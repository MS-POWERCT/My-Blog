export default {
  ...
  Title: '陈义程博客',
  // 网站地址
  Site: 'https://www.chenyicheng.cn',
  // 网站副标题
  Subtitle: '青青子衿,悠悠我心.',
  // 网站描述
  Description: '陈义程博客 专注于分享作者的生活、音乐和旅行的热爱。',
  // 网站作者
  Author: '.Cheng',
  // 作者头像
  ...
  TypeWriteList: [
    '青青子衿,悠悠我心.',
    "Your blue collar, my endless longing.",
  ],
  // 网站创建时间
  ...
  HomeBanner: {
    ...
    PageHeight: '28.88rem',
    // 背景
    background: "url('/assets/images/talking/shan.jpg') no-repeat center 60%/cover",
  },
  // 博客主题配置
  Theme: {
    // 颜色请用 16 进制颜色码
  ...
  Reward: {
    // 支付宝收款码
    AliPay: '/assets/images/alipay.jpeg',
    // 微信收款码
