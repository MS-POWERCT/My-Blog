...
const about: AboutConfig = {
  ...
  Intro: [
    ...
    '<strong>在 Web 开发方面</strong>，我熟悉 Vue / React 生态圈，关注现代 CSS、Astro 等构建工具，以及前端性能优化、代码质量与工程化。',
    '<strong>在后端与云计算领域</strong>，我使用 PHP / Node.js 开发服务端，也长期接触 Docker、Nginx、Linux 运维、Cloudflare / 腾讯云 等边缘计算与 CDN 方案。',
  ...
  Timeline: [
    ...
    { date: '2026-06', title: '文字农场上线',       desc: '一款复古文字风的 QQ 农场小游戏，朋友圈小范围走红。' },
    { date: '2026-06', title: '自律打卡 App',       desc: '结合 AI 能力，完成全栈个人自律打卡应用的 1.0 发布。' },
    // { date: '2025-01', title: 'AI 工作流落地',      desc: '开始将 LLM 融入日常开发与内容生产，效率显著提升。' },
