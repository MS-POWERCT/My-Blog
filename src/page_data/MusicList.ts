...
const jay = '/assets/music/avatars/周杰伦.jpg'
const yunduo = '/assets/music/avatars/云朵.jpg'

/** 音乐页歌单：mp3 放 public/assets/music/ 后在这里加一首即可 */
export default [
  { name: '以父之名', artist: '周杰伦', url: '/assets/music/周杰伦-以父之名.mp3', cover: jay },
  { name: '夜曲', artist: '周杰伦', url: '/assets/music/周杰伦-夜曲.mp3', cover: '/assets/music/covers/周杰伦-夜曲.jpg' },
  { name: '麦芽糖', artist: '周杰伦', url: '/assets/music/周杰伦-麦芽糖.mp3', cover: '/assets/music/covers/周杰伦-麦芽糖.jpg' },
