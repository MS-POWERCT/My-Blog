...
const kuaizi = '/assets/music/筷子兄弟/avatar.jpg'
...
export default [
  ...
  { name: '爷爷泡的茶', artist: '周杰伦', url: '/assets/music/周杰伦/爷爷泡的茶.mp3', cover: jay },
  { name: '最伟大的作品', artist: '周杰伦', url: '/assets/music/周杰伦/最伟大的作品.mp3', cover: jay },
  { name: '我的楼兰', artist: '云朵', url: '/assets/music/云朵/我的楼兰.mp3', cover: yunduo },
  { name: '我从来没去过纽约', artist: '筷子兄弟', url: '/assets/music/筷子兄弟/我从来没去过纽约.mp3', cover: kuaizi },
] as MusicTrack[]
