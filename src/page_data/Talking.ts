...
export default {
  ...
  data: [
    ...
    },
    {
      ...
      tags: ['日常'],
      content: talk(`
        想听云朵-我的楼兰，但经常不好找，我就想通过TG找出来放在这个博客中
        然后我就想那我不直接多弄一些歌曲自己听听呢，我就直接在TG中找了些歌曲，然后放在这个博客中
        通过AI去生成了 音乐导航栏的内容
        现在我就可以直接在车上访问我的博客网站，进行听这些歌了，挺不错的
      `)
    },
    {
      ...
      tags: ['日常', '开发'],
      content: talk(`
        从昨天到今天，我一直在开发「记了么」App 2.0 版本。我花费了139元开通了Cursor 月会员，付费的东西就是速度快。
    ...
    },
    {
      ...
      tags: ['日常', '开发'],
      content: talk(`
        今天，我准备开始「记了么」App 2.0 版本的开发。这次主要是把原先的 UI 整体换掉，再补上一些新功能。
